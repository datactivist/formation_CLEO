...
```{r}
solr_search(q='naked_texte:"front national"', rows = 100, sort = "datepubli asc", fl = c("naked_titre", "contributeur_auteur", "naked_texte", "site_name", "url", "datepubli", "site_type")) %>% glimpse
```
